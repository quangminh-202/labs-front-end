...
(function (Transport) {
    ...
    // Class BasicVehicle triển khai Vehicle
    class BasicVehicle {
    ...
    // Class CarVehicle triển khai Car
    class CarVehicle {
    ...
    // Class MotorbikeVehicle triển khai Motorbike
    ...
    // Class VehicleStorageImpl triển khai VehicleStorage
...
// Sử dụng namespace Transport
const owner = new Transport.Person("Nguyen", "Quang", "Minh", new Date("1999-01-01"), Transport.DocType.Паспорт, "AB", "123456");
const car = new Transport.CarVehicle("Toyota", "Camry", 2020, "VIN123", "ABC-123", owner, Transport.CarBodyType.Седан, Transport.CarClass.D);
const motorbike = new Transport.MotorbikeVehicle("Honda", "CBR", 2021, "VIN456", "XYZ-789", owner, "Carbon", true);
owner.printInfo();
car.printVehicleInfo();
motorbike.printVehicleInfo();
const carStorage = new Transport.VehicleStorageImpl(new Date(), [car]);
console.log("Автомобили в хранилище:", carStorage.getAllVehicles());
const motorbikeStorage = new Transport.VehicleStorageImpl(new Date(), [motorbike]);
