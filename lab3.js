...
const owner = new Person("Nguyen", "Quang", "Minh", new Date("1999-01-01"), DocType.Паспорт, "AB", "123456");
const car = new CarVehicle("Toyota", "Camry", 2020, "VIN123", "ABC-123", owner, CarBodyType.Седан, CarClass.D);
const motorbike = new MotorbikeVehicle("Honda", "CBR", 2021, "VIN456", "XYZ-789", owner, "Carbon", true);
owner.printInfo();
car.printVehicleInfo();
motorbike.printVehicleInfo();
const carStorage = new VehicleStorageImpl(new Date(), [car]);
